...
describe('@rocketh/core - Environment Integration Tests', () => {
    describe('Account Resolution in Context', () => {
        ...
        it('should demonstrate mixing named accounts and hex addresses', async () => {
            ...
            const hexAddress = '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266';
    ...
    describe('Environment Setup', () => {
        describe('ABI Merging in Context', () => {
            it('should demonstrate merging ABIs for proxy deployment', async () => {
                ...
                expect(result.mergedABI.some((f) => f.name === 'getValue')).toBe(true);
                expect(result.mergedABI.some((f) => f.name === 'setValue')).toBe(true);
                expect(result.mergedABI.some((f) => f.name === 'owner')).toBe(true);
                expect(result.mergedABI.some((f) => f.name === 'transferOwnership')).toBe(true);
            });
...
//# sourceMappingURL=environment.integration.test.js.map