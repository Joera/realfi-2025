      ...
      app.innerHTML = `
        ...
        <div class="back">
          ...
          <div>
            ...
            <p>
You’re invited to take part in a short crypto art & community survey,
created for the RealFi Hack 2025 by Funding The Commons.

Powered by Nillion for complete data privacy and Human Network
for passwordless security — so you can share safely, honestly, and anonymously.

            </p>

          </div>

          <h3>scan, share, stay private</h3>
